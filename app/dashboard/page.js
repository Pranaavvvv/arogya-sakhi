        ...
        <div className="dash-header-content">
          <div className="dash-greeting">
            <div>
              ...
              <h1 className="dash-greeting-name">Hello, Sakhi! 👋</h1>
              <p className="dash-greeting-sub">How are you feeling today?</p>
            </div>
            <div className="dash-header-actions">
              <button className="dash-notify-btn" aria-label="Notifications">
      ...
      <div className="dash-metrics stagger-children">
        ...
        <div className="dash-metric-card dash-metric-risk">
          <div className="dash-metric-header">
            <span className="material-symbols-rounded" style={{ color: "#E8728A" }}>monitor_heart</span>
          ...
          <div className="dash-gauge-wrapper">
            <svg viewBox="0 0 140 80" className="dash-gauge-svg">
              ...
              <path d="M 15 75 A 55 55 0 0 1 125 75" fill="none" stroke="#F2F2F2" strokeWidth="12" strokeLinecap="round" />
              <path d="M 15 75 A 55 55 0 0 1 125 75" fill="none" stroke="url(#gaugeGrad)" strokeWidth="12" strokeLinecap="round"
                strokeDasharray="173" strokeDashoffset="86" className="dash-gauge-fill" />
              <circle cx="70" cy="30" r="4" fill="#E8728A" className="dash-gauge-needle" />
            </svg>
          </div>
          <span className="badge badge-warning" style={{ alignSelf: "center" }}>Moderate</span>
        </div>

        {/* Iron Intake */}
        <div className="dash-metric-card dash-metric-iron">
          <div className="dash-metric-header">
            <span className="material-symbols-rounded" style={{ color: "#7DCBA4" }}>restaurant</span>
        ...
        <div className="dash-metric-card dash-metric-hydration">
          <div className="dash-metric-header">
            <span className="material-symbols-rounded" style={{ color: "#4DD0E1" }}>water_drop</span>
          ...
          <div className="dash-ring-wrapper">
            <svg viewBox="0 0 100 100" className="dash-ring-svg">
              ...
              <circle cx="50" cy="50" r="40" fill="none" stroke="#4DD0E1" strokeWidth="10"
                strokeLinecap="round" strokeDasharray="251" strokeDashoffset="131"
                transform="rotate(-90 50 50)" className="dash-ring-fill" />
            </svg>
      ...
      <section className="dash-section">
        <div className="dash-tip-card">
          <div className="dash-tip-header">
            <span className="material-symbols-rounded icon-filled" style={{ color: "#7DCBA4" }}>lightbulb</span>
